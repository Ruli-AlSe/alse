  ...
  return (
    <nav className="w-full px-4 py-2 flex justify-between items-center bg-blue-200 dark:bg-dark-blue border-b-2">
      ...
      <div className="hidden md:flex justify-center items-center">
        <Link
          className="py-1.5 px-3 m-1 text-center bg-blue-200 border border-slate-800 rounded-md text-light-blue hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 hidden md:inline-block "
          href="/blog"
        >
          Blog
        </Link>
